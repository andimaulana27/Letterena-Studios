...
export const metadata: Metadata = {
  title: {
    default: 'Letterena Studios | Premium Fonts for Designers', // DIUBAH
    template: '%s | Letterena Studios', // DIUBAH
  },
...
export default function RootLayout({
  ...
  const supabaseStorageUrl = "https://eugolxdrokzjjixgxyom.supabase.co"; // DIUBAH
