...
const ContentSecurityPolicy = `
  ...
  img-src 'self' data: blob: eugolxdrokzjjixgxyom.supabase.co avatar.iran.liara.run lh3.googleusercontent.com *.paypal.com *.sandbox.paypal.com *.paypalobjects.com *.adtrafficquality.google;
  ...
  font-src 'self' fonts.gstatic.com eugolxdrokzjjixgxyom.supabase.co blob:;
...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'eugolxdrokzjjixgxyom.supabase.co',
        port: '',
