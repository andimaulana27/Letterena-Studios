...
export const metadata: Metadata = {
  // --- PERUBAHAN DI SINI ---
  title: 'About Us | Letterena Studios',
  description: 'Learn about Letterena Studios, your premier destination for fonts that seamlessly blend retro charm, classy sophistication, and modern innovation.',
  // --- AKHIR PERUBAHAN ---
};
