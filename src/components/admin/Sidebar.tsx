...
export default function Sidebar({ counts, profile }: SidebarProps) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col bg-gradient-to-b from-brand-darkest from-50% to-brand-accent/40 text-brand-light shadow-lg sticky top-0 h-screen">
